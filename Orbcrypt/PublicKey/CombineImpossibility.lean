...
-- ============================================================================
-- W6.8 of structural review 2026-05-06: deleted four deterministic-OIA
-- theorems formerly in this file (`equivariant_combiner_breaks_oia`,
-- `oia_forces_combine_constant_in_snd`,
-- `oia_forces_combine_constant_on_orbit`,
-- `oblivious_sample_equivariant_obstruction`) along with `OIA` itself.
-- The non-vacuous probabilistic counterpart
-- `concrete_combiner_advantage_bounded_by_oia` (Workstream E6) carries
-- the substantive ε-smooth combiner-advantage upper bound; the W4
-- fixture-level result `combinerDistinguisherAdvantage_eq_half_on_R07`
-- (audit script) shows the bound is attained on a concrete instance.
-- ============================================================================

-- ============================================================================
-- Workstream E6 — Probabilistic refinement (post-W6 sole content)
-- ============================================================================
