...
64 work units in 6 phases spanning 16 weeks (~140 engineer-hours).
...
| [Phase 4 — Core Theorems](formalization/phases/PHASE_4_CORE_THEOREMS.md) | Correctness proof, invariant attack theorem, OIA ⟹ IND-1-CPA reduction (Weeks 7–10, 16 units, ~38h) |
| [Phase 5 — Concrete Construction](formalization/phases/PHASE_5_CONCRETE_CONSTRUCTION.md) | S\_n action on bitstrings, HGOE instance, Hamming weight defense proof (Weeks 11–14, 12 units, ~28h) |
| [Phase 6 — Polish & Documentation](formalization/phases/PHASE_6_POLISH_AND_DOCUMENTATION.md) | `sorry` audit, docstrings, CI configuration, final verification (Weeks 15–16, 13 units, ~23h) |
